"""Ethereum wallet signature verification for optional login — ported verbatim from
GaX/app/core/wallet_auth.py (pure Python, no framework dependency)."""
import re
import secrets
...
def nonce_expires_at() -> datetime:
    return timezone.now() + timedelta(minutes=NONCE_TTL_MINUTES)
